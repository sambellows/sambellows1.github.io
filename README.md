...
## To do:
1. Create more animations with quick explanations of why they're useful.
2. Add more to the bio/about me section.
3. Display more examples of past work on Github.
